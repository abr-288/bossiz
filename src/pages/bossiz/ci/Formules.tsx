...
import bannerImage from "@/assets/hotel-azalai.jpg";

const BossizCIFormules = () => {
  ...
  if (loading || !content) {
    return (
      <BossizSiteLayout country="ci" activePage="formules">
  ...
  return (
    <BossizSiteLayout country="ci" activePage="formules" tagline={content.tagline}>
      ...
      <section className="py-24 bg-bossiz-ci-green-pale min-h-[80vh]">
        <div className="max-w-6xl mx-auto px-6 lg:px-10">
          ...
          <p className="text-center text-sm uppercase tracking-[0.2em] text-bossiz-ci-green font-semibold mb-6">
            ...
            {content.monthlyPlansList.map((plan) => (
              ...
              >
                <CardContent className="p-10 text-center">
                  ...
                  <Button
                    className="w-full rounded-full bg-bossiz-ci-green text-white hover:bg-bossiz-ci-green-light font-semibold text-sm py-5"
            ...
            {content.shortStayPlansList.map((plan) => (
              <Card key={plan.name} className="rounded-xl border border-bossiz-cream-taupe/40 bg-white/60">
                <CardContent className="p-8 text-center">
                  ...
                  <button
                    onClick={() => navigate("/support")}
                    className="text-xs font-semibold uppercase tracking-wider text-bossiz-ci-green hover:text-bossiz-gold-dark"
                  >
                    {t("bossizSite.requestQuote")} →
                  </button>
                </CardContent>
...
export default BossizCIFormules;
