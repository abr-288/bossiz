...
-- Contenu public (page d'accueil) : lecture ouverte à tous, y compris les
-- visiteurs non connectés, à l'image de site_config.
CREATE POLICY "homepage_features is readable by everyone" ON homepage_features
  FOR SELECT USING (true);

CREATE POLICY "homepage_sections is readable by everyone" ON homepage_sections
  FOR SELECT USING (true);
