-- Migration script for Majestic Club tables
-- Run this with: psql -d traversee-connect -f migrate-majestic.sql
...
DO $$
BEGIN;
    RAISE NOTICE 'Majestic Club VIP module tables created successfully!';
END;
$$;
